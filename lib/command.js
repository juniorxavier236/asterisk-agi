module.exports = [
  ...
  },
  {
    ...
    paramRules: [
      ...
      {
        default: 'wav', // Definindo o formato padrão como 'wav'
      },
      null, // ESCAPE_DIGITS
      {
        prepare: function (value) {
          return value * 1000; // TIMEOUT in milliseconds
        },
      },
      null, // OFFSET_SAMPLES
      {
        prepare: function (value) {
          return value ? '1' : '0'; // BEEP: 1 (true) or 0 (false)
        },
      },
      {
        prepare: function (value) {
          return 's=' + (value || 0); // s=SILENCE in seconds
        },
      },
    ],
  },
